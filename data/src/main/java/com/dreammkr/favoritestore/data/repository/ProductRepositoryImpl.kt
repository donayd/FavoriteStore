...
internal fun ProductEntity.toDomain() = Product(id, title, price, description, category, image, isFavorite)
internal fun Product.toEntity() = ProductEntity(id, title, price, description, category, image, isFavorite)
